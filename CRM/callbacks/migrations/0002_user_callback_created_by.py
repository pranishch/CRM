    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('USER', 'Regular User'), ('MANAGER', 'Manager'), ('ADMIN', 'Admin')], default='USER', max_length=10)),
        ...
        migrations.AddField(
            model_name='callback',
            name='created_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='callbacks.user'),
        ),
    ]
